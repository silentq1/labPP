    ...
    public partial class DatabaseCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Wall st. 1", "Ivanov Ivan Ivanovich" },
                    { 2, "Sevastopolskaya st. 24", "Petrov Ivan Sergeevich" }
                });

            migrationBuilder.InsertData(
                table: "Shops",
                columns: new[] { "ShopId", "Address", "Budget", "Name" },
                values: new object[,]
                {
                    { 1, "Botevgradskaya 12", 100, "Citylink" },
                    { 2, "Bogdana Hmelnickogo 18", 400, "DNS" }
                });
